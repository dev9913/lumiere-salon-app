...
CREATE TABLE "SalonInfo" (
    ...
    CONSTRAINT "SalonInfo_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "WeeklySchedule_staffId_dayOfWeek_idx" ON "WeeklySchedule"("staffId", "dayOfWeek");
...
-- AddForeignKey
ALTER TABLE "WeeklySchedule" ADD CONSTRAINT "WeeklySchedule_staffId_fkey" FOREIGN KEY ("staffId") REFERENCES "Staff"("id") ON DELETE CASCADE ON UPDATE CASCADE;
